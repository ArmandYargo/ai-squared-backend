...
def assess_ram_readiness_for_machine(
    ...
    *,
    ...
    if exc_re:
        # Pandas warns if regex contains capturing groups (...).
        # Convert to non-capturing groups (?:...) to keep behavior identical and silence the warning.
        exc_re = re.sub(r"\((?!\?:)", r"(?:", str(exc_re))
