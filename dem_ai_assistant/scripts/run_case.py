...
def run_case(material_file: str, scenario_file: str, geometry_file: str) -> None:
    material_cfg = load_yaml_config(PROJECT_ROOT / "configs" / "materials" / material_file)
    scenario_cfg = load_yaml_config(PROJECT_ROOT / "configs" / "scenarios" / scenario_file)
    geometry_cfg = load_yaml_config(PROJECT_ROOT / "configs" / "geometry" / geometry_file)
...
if __name__ == "__main__":
    run_case(
        material_file="iron_ore_wet_fines.yaml",
        scenario_file="steady_state.yaml",
        geometry_file="transfer_point_template.yaml",
    )