"""
Entry point when running from project root: python main.py
Uses the same pipeline as scripts/run_baseline.py (execute_case + KPIs + findings).
"""
...
def main() -> None:
    ...
    class SimResultShim:
        def __init__(self, run_dir: Path, scenario_name: str, notes: str) -> None:
